...
GPIO_PTB_GPIO = 0x0000; //全亮
delay1(400000);

//pattern 2
for(i=0; i<16; i++){  //兩個燈間隔亮 然後往左一次移一格
	GPIO_PTB_GPIO = 0xcccc; //1100 1100 1100 1100
	delay1(200000);
	GPIO_PTB_GPIO = 0x9999; //1001 1001 1001 1001
	delay1(200000);
	GPIO_PTB_GPIO = 0x3333; //0011 0011 0011 0011
	delay1(200000);
	GPIO_PTB_GPIO = 0x6666; //0110 0110 0110 0110
	delay1(200000);
}
